...
export default function Attendance() {
    ...
    const filtered = records.filter((r) => {
        ...
        if (search) {
            ...
            return personName(r.personnelId).toLowerCase().includes(q);
        }
        return true;
    });
