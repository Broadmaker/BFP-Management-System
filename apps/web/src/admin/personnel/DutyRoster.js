...
export default function DutyRoster() {
    ...
    function getShift(personId, date) {
        ...
        return roster.find((s) => s.personnelId === personId && s.date === ds);
    }
    function save() {
        ...
        setRoster((prev) => {
            const existing = prev.findIndex((s) => s.personnelId === form.personnelId && s.date === dateStr);
    ...
    function removeShift(personId, date) {
        const ds = formatDate(date);
        setRoster((prev) => prev.filter((s) => !(s.personnelId === personId && s.date === ds)));
    }
