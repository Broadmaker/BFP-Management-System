...
export default function Certificates() {
    ...
    function remove(id) { if (confirm('Delete this certificate?'))
    ...
    const filtered = items.filter((r) => {
        ...
        if (search) {
            ...
            return r.establishmentName?.toLowerCase().includes(q) || r.certificateNumber.toLowerCase().includes(q);
        }
        return true;
    });
