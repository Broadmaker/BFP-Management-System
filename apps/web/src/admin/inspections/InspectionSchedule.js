...
export default function InspectionSchedule() {
    ...
    function getInspectionsForDate(dateStr) {
        return items.filter((s) => s.scheduledDate === dateStr);
    }
    async function save() {
