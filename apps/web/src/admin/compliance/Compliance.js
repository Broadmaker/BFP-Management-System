...
export default function Compliance() {
    ...
    function updateEstablishmentStatus(id, status) {
    ...
    const filteredViolations = violations.filter((r) => {
        ...
        if (search) {
            ...
            return r.establishmentName?.toLowerCase().includes(q) || r.description.toLowerCase().includes(q);
        }
        return true;
    });
