...
export default function Maintenance() {
    ...
    const filtered = items.filter((r) => {
        ...
        if (search) {
            ...
            return (r.description || '').toLowerCase().includes(q) || r.assetType?.toLowerCase().includes(q);
        }
        return true;
    });
